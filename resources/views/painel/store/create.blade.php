                            ...
                            <div id="tab-info" class="tab-pane @if(\Request::input('tab') == 1 || \Request::input('tab') == null) active @endif">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group @if ($errors->has('type_person')) has-error @endif">
                                        ...
                                        <div class="col-sm-8">
                                            {{ Form::select('type_person', ['F' => 'Física', 'J' => 'Jurídica'], null, ['class' => 'form-control type_person', 'placeholder' => 'Selecione']) }}
                                        </div>
                                    </div>
                                    <!-- CPF/CNPJ -->
                                    <div class="form-group @if ($errors->has('cpf_cnpj')) has-error @endif">
                                        ...
                                        <div class="col-sm-8">
                                            {{ Form::text('cpf_cnpj', null, ['class' => 'form-control cpf_cnpj']) }}
                                        </div>
                                    </div>
                                    <!-- Inscrição Estadual -->
                                    ...
                                    <div class="form-group @if ($errors->has('phone')) has-error @endif">
                                        ...
                                        <div class="col-sm-8">
                                            {{ Form::text('phone', null, ['class' => 'form-control phones']) }}
                                        </div>
                                    </div>
                                    <!-- Imagem -->
                            ...
                            <div id="tab-address" class="tab-pane @if(\Request::input('tab') == 2) active @endif">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group @if ($errors->has('complement')) has-error @endif">
                                        ...
                                        <div class="col-sm-8">
                                            {{ Form::text('complement', null, ['class' => 'form-control' , 'readonly' => 'readonly']) }}
                                        </div>
                                    </div>
                                    <!-- Bairro -->
                                    <div class="form-group @if ($errors->has('neighborhood')) has-error @endif">
                                        ...
                                        <div class="col-sm-8">
                                            {{ Form::text('neighborhood', null, ['class' => 'form-control' , 'readonly' => 'readonly']) }}
                                        </div>
                                    </div>
                                    <!-- Cidade -->
                                    <div class="form-group @if ($errors->has('city_id')) has-error @endif">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            {{ Form::text('city', null, ['class' => 'form-control', 'placeholder' => 'Selecione' , 'readonly' => 'readonly']) }}
                                        </div>
                                    </div>
                                    <!-- Estado -->
                                    <div class="form-group @if ($errors->has('state_id')) has-error @endif">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            {{ Form::text('state', null, ['class' => 'form-control', 'placeholder' => 'Selecione' , 'readonly' => 'readonly']) }}
                                        </div>
                                    </div>
                                    <!-- Maps -->
