                    ...
                    {!! Form::model($data, ['method' => 'PATCH','route' => [$routeFather .'.update', $data->id], 'class' => 'form-horizontal', 'files' => true, 'autocomplete' => 'off'] ) !!}
                                ...
                                <?php
                                    ...
                                    switch ($property){
                                        ...
                                        case 'birthday':
                                            ...
                                            break;
                                        case 'date':
                                            echo Form::date($property, $data->date, ['class' => 'form-control']);
                                            break;
                                        case 'password':
                                        ...
                                        case 'days':
                                            ...
                                            break;
                                        case 'price':
                                            echo Form::text($property, $data->getPrice(), ['class' => 'form-control money']);
                                            break;
                                        default:
                                            echo Form::text($property, null, ['class' => 'form-control']);
                                            break;
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                ...
                                <button class="btn btn-success" value="" name="submit" type="submit">Salvar</button>
                                <button class="btn btn-info" value="close" name="submit" type="submit">Salvar e Fechar</button>
                            </div>
                        </div>
